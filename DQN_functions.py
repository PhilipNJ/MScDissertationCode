...
# class DQNAgent:
#     def __init__(self, state_size, action_size,window_size, lr=0.00001, gamma=0.99, epsilon=1.0, epsilon_min=0.01, epsilon_decay=0.999):
...
#         self.model = ConvDQN(state_size, action_size,window_size)
...
class DQNAgent:
    def __init__(self, state_size, action_size, window_size, lr=0.00001, gamma=0.95, epsilon=1.0, epsilon_min=0.01, epsilon_decay=0.999):
        self.state_size = state_size
        self.action_size = action_size
        self.memory = ReplayMemory(50000)
        self.gamma = gamma
...
#                 else:
#                     has_open_position = False  # Sell the open position
#                     sell_price = state[-1][3]  # Store the sell price
#                     days_since_last_buy = 0  # Reset days since last buy
...
#                 else:
#                     has_open_position = True  # Buy, opening a new position
#                     buy_price = state[-1][3]  # Store the buy price
#                     days_since_last_buy = 0  # Reset days since last buy
